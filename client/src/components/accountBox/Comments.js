...
// import React, { useState, useEffect } from "react";
// import { useMutation, useQuery } from "@apollo/client";
// import { ADD_COMMENT, QUERY_SINGLE_PROJECT } from "../../utils/queries";
// import Auth from "../../utils/auth";
// import Profile from "./Profile";

// function Comments({ projectId, setCommentsCount }) {
//   const [commentText, setCommentText] = useState("");
//   const [addComment, { error }] = useMutation(ADD_COMMENT);
...
//       setCommentText("");
//       refetch();
//       updateCommentsCount(); // Update comments count after adding a comment
//     } catch (err) {
//       console.error(err);
//     }
//   };
...
//     const updatedCommentsCount = data?.project.comments.length || 0;
//     setCommentsCount((prevCounts) => ({
//       ...prevCounts,
//       [projectId]: updatedCommentsCount,
//     }));
//   };
